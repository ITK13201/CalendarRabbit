...
func (_c *AppSettingCreate) SetTimezone(v string) *AppSettingCreate {
	_c.mutation.SetTimezone(v)
	return _c
}

// SetNillableTimezone sets the "timezone" field if the given value is not nil.
func (_c *AppSettingCreate) SetNillableTimezone(v *string) *AppSettingCreate {
	if v != nil {
		_c.SetTimezone(*v)
	}
	return _c
...
func (_c *AppSettingCreate) check() error {
	if _, ok := _c.mutation.Timezone(); !ok {
		return &ValidationError{Name: "timezone", err: errors.New(`ent: missing required field "AppSetting.timezone"`)}
	}
