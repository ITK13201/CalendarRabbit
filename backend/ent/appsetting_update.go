...
func (_u *AppSettingUpdate) SetTimezone(v string) *AppSettingUpdate {
	_u.mutation.SetTimezone(v)
	return _u
}

// SetNillableTimezone sets the "timezone" field if the given value is not nil.
func (_u *AppSettingUpdate) SetNillableTimezone(v *string) *AppSettingUpdate {
	if v != nil {
		_u.SetTimezone(*v)
	}
	return _u
...
// SetTimezone sets the "timezone" field.
func (_u *AppSettingUpdateOne) SetTimezone(v string) *AppSettingUpdateOne {
	_u.mutation.SetTimezone(v)
	return _u
}
