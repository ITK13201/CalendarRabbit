...
func (_u *MessageUpdate) SetConversationID(id int) *MessageUpdate {
...
func (_u *MessageUpdate) AddProposalIDs(ids ...int) *MessageUpdate {
	_u.mutation.AddProposalIDs(ids...)
	return _u
}

// AddProposals adds the "proposals" edges to the EventProposal entity.
func (_u *MessageUpdate) AddProposals(v ...*EventProposal) *MessageUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *MessageUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.ProposalsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   message.ProposalsTable,
			Columns: []string{message.ProposalsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// SetConversationID sets the "conversation" edge to the Conversation entity by ID.
func (_u *MessageUpdateOne) SetConversationID(id int) *MessageUpdateOne {
	_u.mutation.SetConversationID(id)
	return _u
}
...
// AddProposalIDs adds the "proposals" edge to the EventProposal entity by IDs.
func (_u *MessageUpdateOne) AddProposalIDs(ids ...int) *MessageUpdateOne {
	_u.mutation.AddProposalIDs(ids...)
	return _u
}

// AddProposals adds the "proposals" edges to the EventProposal entity.
func (_u *MessageUpdateOne) AddProposals(v ...*EventProposal) *MessageUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearProposals clears all "proposals" edges to the EventProposal entity.
func (_u *MessageUpdateOne) ClearProposals() *MessageUpdateOne {
	_u.mutation.ClearProposals()
	return _u
}

// RemoveProposalIDs removes the "proposals" edge to EventProposal entities by IDs.
func (_u *MessageUpdateOne) RemoveProposalIDs(ids ...int) *MessageUpdateOne {
	_u.mutation.RemoveProposalIDs(ids...)
	return _u
}

// RemoveProposals removes "proposals" edges to EventProposal entities.
func (_u *MessageUpdateOne) RemoveProposals(v ...*EventProposal) *MessageUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
