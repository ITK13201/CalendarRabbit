...
// was not loaded in eager-loading.
func (e ConversationEdges) ProposalsOrErr() ([]*EventProposal, error) {
	if e.loadedTypes[1] {
...
// QueryProposals queries the "proposals" edge of the Conversation entity.
func (_m *Conversation) QueryProposals() *EventProposalQuery {
	return NewConversationClient(_m.config).QueryProposals(_m)
}
